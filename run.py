...
def run_main():
    ...
    while True:
        # x = threading.Thread(target=mqtt_publish_thread, args=(client, people_inside,), daemon=True)
        #
        # x.start()
            ...
            # to determine direction
                ...
                if not to.counted:
                    ...
                    # center line, count the object
                        ...
                        # if sum(people_inside) >= config.Threshold:
                    ...
                    if people_inside < 0:
                        people_inside = 0
                    print("Total people inside: " + str(people_inside))
        ...
        # client.publish("alberto/num_persons", str(people_inside))
